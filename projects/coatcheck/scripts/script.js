...
document.getElementById("checkIn").addEventListener("click",
    function () {
        ...
        if (document.getElementById("nameTyped").value === "" || document.getElementById("badgeTyped").value === "" || document.getElementById("badgeNumTyped").value === "") {
            ...
            checkedInArray.push([nameCapitalized, document.getElementById("badgeTyped").value, document.getElementById("badgeNumTyped").value, timeNow, "<input onclick='returnBadge(this)' type='button' class='tableButton' value='Return'>"]);
            clearTable();
            displayArray();
...
function exportToCsv() {
    ...
    checkedInArray.forEach(function(RowItem, RowIndex) {
        ...
        var x = document.createElement("A");
            ...
            x.setAttribute("download", dateNow + " Coat Check Log.csv");
